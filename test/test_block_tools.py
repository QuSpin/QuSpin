...
def test():
	...
	for psi_e_1,psi_e_2,psi_b_1,psi_b_2 in zip(psi_exact_1,psi_exact_2,psi_block_1,psi_block_2):
	...
	for psi_e_1,psi_b_1 in zip(psi_exact_1,psi_block_1):
		np.testing.assert_allclose(psi_b_1,psi_e_1,atol=1e-7)

	for psi_e_2,psi_b_2 in zip(psi_exact_2,psi_block_2):
		np.testing.assert_allclose(psi_b_2,psi_e_2,atol=1e-7)
