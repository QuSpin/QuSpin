...
def test():
    ...
    rho_test = {}
    rho_test["1/2"] = np.array([[0.5, -0.43644424], [-0.43644424, 0.5]])
    rho_test["1"] = np.array(
        [
            [0.3087624, -0.31805836, 0.22282817],
            [-0.31805836, 0.38247519, -0.31805836],
            [0.22282817, -0.31805836, 0.3087624],
        ]
    )
    rho_test["3/2"] = np.array(
        [
            [0.31042621, -0.22463578, 0.1369919, -0.08695713],
    ...
    rho_test["2"] = np.array(
        [
            [0.38625202, -0.19306019, 0.06839545, -0.02735268, 0.01846154],
    ...
    for S in ["1/2", "1", "3/2", "2"]:
        ...
        _ent_entropy(psi, basis, DM="chain_subsys")["DM_chain_subsys"]
