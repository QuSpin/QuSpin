...
if N_half != 10:
    print(
        "symmetry masks are hard-coded and work only for N=10; \n\
...
# define maps dict
maps = dict(
    T_block=(translation, N_half, 0, T_args),
...
# create user basis
basis = user_basis(
    np.uint32, N, op_dict, allowed_ops=set("xyz"), sps=2, pcon_dict=pcon_dict, **maps
)
# print basis
print(basis)
