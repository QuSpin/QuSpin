...
# compute basis
basis = spin_basis_1d(L,S="1",m=0,kblock=0,pblock=1,) # and positive parity sector
...
H_ave = 0.5*hamiltonian(static_ave,dynamic,basis=basis,dtype=dtype_real)
...
E_density[0]=H_ave.expt_value(psi).real/L
...
plt.plot(times, s_p*times/times)
