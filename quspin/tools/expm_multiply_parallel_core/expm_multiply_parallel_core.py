...
class expm_multiply_parallel(object):
    ...
    def __init__(self,A,a=1.0,dtype=None,copy=False):
        ...
        if dtype is None:
            if A.dtype in [_np.float32,_np.float64,_np.complex64,_np.complex128]:
                self._dtype = _np.result_type(A.dtype,a_dtype_min)
            else:
    ...
    @property
    def dtype(self):
        """datatype of unitary generated by this object."""
