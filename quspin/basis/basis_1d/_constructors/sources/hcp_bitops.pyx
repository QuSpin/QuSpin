...
cdef basis_type flip_all(basis_type I, int length,basis_type[:] pars):
#     flip all bits
    cdef basis_type one = 1
    cdef basis_type zero = 0
    cdef basis_type Imax
...
cdef basis_type flip_sublat_A(basis_type I, int length,basis_type[:] pars):
...
cdef basis_type flip_sublat_B(basis_type I, int length,basis_type[:] pars):
