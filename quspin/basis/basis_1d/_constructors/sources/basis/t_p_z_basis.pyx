...
def make_t_p_z_basis(int L ,int pblock,int zblock,unsigned int kblock,int a, _np.ndarray[NP_INT8_t,ndim=1] N, _np.ndarray[NP_INT16_t,ndim=1] m, _np.ndarray[NP_UINT32_t, ndim=1] basis):
...
def make_m_t_p_z_basis(int L, int Nup, int pblock, int zblock, int kblock, int a, _np.ndarray[NP_INT8_t,ndim=1] N, _np.ndarray[NP_INT16_t,ndim=1] m, _np.ndarray[NP_UINT32_t,ndim=1] basis):
	cdef double k = 2.0*_np.pi*kblock*a/L
