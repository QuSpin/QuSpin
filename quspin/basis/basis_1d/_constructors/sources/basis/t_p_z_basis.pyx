...
cdef state_type make_t_p_z_basis_template(shifter shift,bitop fliplr,ns_type next_state, void *ns_pars,
	...
	for i in range(MAX):
		CheckState_T_P_Z_template(shift,fliplr,flip_all,kblock,L,s,a,R,ns_pars)
		r = R[0]
		mp = R[1]
		mz = R[2]
		mpz = R[3]
