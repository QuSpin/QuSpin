...
def f_pz_op(_np.ndarray[NP_INT8_t,ndim=1] N, _np.ndarray[NP_UINT32_t,ndim=1] basis, str opstr, _np.ndarray[NP_INT32_t,ndim=1] indx, float complex J, int L, int pzblock):
	cdef unsigned int s
...
def d_pz_op(_np.ndarray[NP_INT8_t,ndim=1] N, _np.ndarray[NP_UINT32_t,ndim=1] basis, str opstr, _np.ndarray[NP_INT32_t,ndim=1] indx, double complex J, int L, int pzblock):
	cdef unsigned int s
	cdef int error,ss,i,Ns,qg
	cdef _np.ndarray[NP_UINT32_t,ndim = 1] R = _np.zeros(2,NP_UINT32)
	cdef _np.ndarray[NP_INT32_t,ndim=1] row
...
def g_pz_op(_np.ndarray[NP_INT8_t,ndim=1] N, _np.ndarray[NP_UINT32_t,ndim=1] basis, str opstr, _np.ndarray[NP_INT32_t,ndim=1] indx, long double complex J, int L, int pzblock):
	cdef unsigned int s
	cdef int error,ss,i,Ns,qg
	cdef _np.ndarray[NP_UINT32_t,ndim = 1] R = _np.zeros(2,NP_UINT32)
	cdef _np.ndarray[NP_INT32_t,ndim=1] row
