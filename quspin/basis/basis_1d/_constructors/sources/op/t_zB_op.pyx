...
def f_t_zB_op(_np.ndarray[NP_INT8_t,ndim=1] N,_np.ndarray[NP_INT8_t,ndim=1] m, _np.ndarray[basis_type,ndim=1] basis, str opstr, _np.ndarray[NP_INT32_t,ndim=1] indx, float complex J, int L, int zBblock, int kblock, int a):
	cdef state_type s
	...
	for i in range(Ns):
		s = row[i]
		RefState_T_ZB_template(shift,flip_sublat_B,s,L,a,&R[0])
...
def d_t_zB_op(_np.ndarray[NP_INT8_t,ndim=1] N,_np.ndarray[NP_INT8_t,ndim=1] m, _np.ndarray[basis_type,ndim=1] basis, str opstr, _np.ndarray[NP_INT32_t,ndim=1] indx, double complex J, int L, int zBblock, int kblock, int a):
	cdef state_type s
	cdef int error,ss,i,Ns,l,gB
	cdef _np.ndarray[basis_type,ndim=1] R = _np.zeros(3,dtype=basis.dtype)
	cdef _np.ndarray[NP_INT32_t,ndim=1] row
