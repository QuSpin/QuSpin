...
def f_t_zA_op(_np.ndarray[NP_INT8_t,ndim=1] N,_np.ndarray[NP_INT8_t,ndim=1] m, _np.ndarray[NP_UINT32_t,ndim=1] basis, str opstr, _np.ndarray[NP_INT32_t,ndim=1] indx, float complex J, int L, int zAblock, int kblock, int a):
	cdef unsigned int s
...
def d_t_zA_op(_np.ndarray[NP_INT8_t,ndim=1] N,_np.ndarray[NP_INT8_t,ndim=1] m, _np.ndarray[NP_UINT32_t,ndim=1] basis, str opstr, _np.ndarray[NP_INT32_t,ndim=1] indx, double complex J, int L, int zAblock, int kblock, int a):
	cdef unsigned int s
	cdef int error,ss,i,Ns,l,gA
	cdef _np.ndarray[NP_UINT32_t,ndim = 1] R = _np.zeros(3,NP_UINT32)
	cdef _np.ndarray[NP_INT32_t,ndim=1] row
...
cdef long double g_MatrixElement_ZA(int L,int zAblock, int kblock, int a, int l, long double k, int gA,NP_INT8_t Nr,NP_INT8_t Nc,NP_INT8_t mr,NP_INT8_t mc):
...
def g_t_zA_op(_np.ndarray[NP_INT8_t,ndim=1] N,_np.ndarray[NP_INT8_t,ndim=1] m, _np.ndarray[NP_UINT32_t,ndim=1] basis, str opstr, _np.ndarray[NP_INT32_t,ndim=1] indx, long double complex J, int L, int zAblock, int kblock, int a):
	cdef unsigned int s
	cdef int error,ss,i,Ns,l,gA
	cdef _np.ndarray[NP_UINT32_t,ndim = 1] R = _np.zeros(3,NP_UINT32)
	cdef _np.ndarray[NP_INT32_t,ndim=1] row
	...
	for i in range(Ns):
		...
		ME[i] *= g_MatrixElement_ZA(L,zAblock,kblock,a,l,k,gA,N[i],N[ss],m[i],m[ss])
...
cdef long double complex G_MatrixElement_ZA(int L,int zAblock, int kblock, int a, int l, long double k, int gA,NP_INT8_t Nr,NP_INT8_t Nc,NP_INT8_t mr,NP_INT8_t mc):
	cdef long double nr,nc
