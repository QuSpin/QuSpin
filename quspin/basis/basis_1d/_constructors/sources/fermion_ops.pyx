...
cdef int fermion_op_func(index_type Ns, basis_type *basis,
...
def fermion_op(_np.ndarray[index_type,ndim=1] row, _np.ndarray[index_type,ndim=1] col, _np.ndarray[matrix_type,ndim=1] ME,
    ...
    return op_template[index_type,basis_type,matrix_type](fermion_op_func,NULL,Ns,&basis[0],opstr,&indx[0],J,&row[0],&col[0],&ME[0])

def fermion_n_op(_np.ndarray[index_type,ndim=1] row, _np.ndarray[index_type,ndim=1] col, _np.ndarray[matrix_type,ndim=1] ME,
              str opstr, _np.ndarray[NP_INT32_t,ndim=1] indx, scalar_type J,
              _np.ndarray[basis_type,ndim=1] basis,**blocks):
    cdef index_type Ns = basis.shape[0]
    return n_op_template[index_type,basis_type,matrix_type](fermion_op_func,NULL,Ns,&basis[0],opstr,&indx[0],J,&row[0],&col[0],&ME[0])
...
def fermion_t_op(_np.ndarray[index_type,ndim=1] row, _np.ndarray[index_type,ndim=1] col, _np.ndarray[matrix_type,ndim=1] ME,
    ...
    cdef int a = blocks["a"]
    return t_op_template[index_type,basis_type,matrix_type](fermion_op_func,NULL,shift,NULL,L,kblock,a,Ns,&N[0],&basis[0],opstr,&indx[0],J,&row[0],&col[0],&ME[0])
