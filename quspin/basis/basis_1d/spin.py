...
class spin_basis_1d_new(basis_1d):
	def __init__(self,L,Nup=None,_Np=None,pauli=True,**blocks):
		input_keys = set(blocks.keys())
		expected_keys = set(["kblock","zblock","zAblock","zBblock","pblock","pzblock","a","count_spins","check_z_symm","L"])
		...
		basis_1d.__init__(self,_ops,L,Np=Nup,_Np=_Np,**blocks)
