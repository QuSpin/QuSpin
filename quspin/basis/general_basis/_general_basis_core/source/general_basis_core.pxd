...
cdef extern from "general_basis_op.h":
	int general_op[I,J,K,T](general_basis_core[I] *B,const int,const unsigned char[], const int[],
						  const double complex, const K, const I[], const J[], K[], K[], T[]) nogil

cdef extern from "general_basis_get_vec.h":
	bool get_vec_general_dense[I,J,T](general_basis_core[I] *B, I[],const J[],const npy_intp,
									const npy_intp,const npy_intp,const T[],double complex,int,T[]) nogil
