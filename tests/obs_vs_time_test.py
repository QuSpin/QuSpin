...
for _i in dtypes.keys():
    ...
    Ozz = hamiltonian(
        [], dynamic_zz, basis=basis, dtype=dtype, check_herm=False, check_symm=False
    )
    H2 = hamiltonian(
    ...
    np.testing.assert_allclose(
        Expn, Expn2, atol=atol, rtol=rtol, err_msg="pure: Failed observable comparison!"
    )
    np.testing.assert_allclose(
        psi_t, psi_t2, atol=atol, rtol=rtol, err_msg="pure: Failed state comparison!"
    )
    np.testing.assert_allclose(
        Sent, Sent2, atol=atol, err_msg="pure: Failed ent entropy comparison!"
    )
    ...
    np.testing.assert_allclose(
        ...
        atol=atol,
        rtol=rtol,
        err_msg="mixed: Failed observable comparison!",
    )
    np.testing.assert_allclose(
        psi_t, psi_t2, atol=atol, rtol=rtol, err_msg="mixed: Failed state comparison!"
    )
    np.testing.assert_allclose(
        Sent, Sent2, atol=atol, err_msg="mixed: Failed ent entropy comparison!"
    )
    ...
    psi_t4 = exp_op(
        H2, a=-1j, start=0.0, stop=2.0, num=20, endpoint=True, iterate=True
    ).dot(psi0)

    Obs = obs_vs_time(psi_t, t, Obs_list, return_state=True, Sent_args=Sent_args)
    Obs2 = obs_vs_time(
        (psi0, E, V), t, Obs_list, return_state=True, Sent_args=Sent_args
    )
    Obs4 = obs_vs_time(psi_t4, t, Obs_list, return_state=True, Sent_args=Sent_args)

    psi_t3 = ED_state_vs_time(psi0, E, V, t, iterate=False)
    psi_t33 = np.asarray(
        [psi for psi in ED_state_vs_time(psi0, E, V, t, iterate=True)]
    ).T
    ...
    np.testing.assert_allclose(
        ...
        atol=atol,
        rtol=rtol,
        err_msg="pure: Failed ent entropy comparison!",
    )
    np.testing.assert_allclose(
        psi_t2,
        psi_t3,
        atol=atol,
        rtol=rtol,
        err_msg="pure: Failed ED_state_vs_time test!",
    )
    np.testing.assert_allclose(
        psi_t3,
        psi_t33,
    ...
    np.testing.assert_allclose(
        psi_t2, psi_t4, atol=atol, rtol=rtol, err_msg="pure: Failed exp_op test!"
    )

    E, V = H2.eigh()

    psi_t = H2.evolve(
        rho0, 0.0, t, eom="LvNE", iterate=False, rtol=solver_rtol, atol=solver_atol
    )
    psi_t4 = exp_op(
        H2, a=1j, start=0.0, stop=2.0, num=20, endpoint=True, iterate=True
    ).sandwich(rho0)
    ...
    Obs = obs_vs_time(psi_t, t, Obs_list, return_state=True, Sent_args=Sent_args)
    Obs2 = obs_vs_time(
        (rho0, E, V), t, Obs_list, return_state=True, Sent_args=Sent_args
    )
    Obs4 = obs_vs_time(psi_t4, t, Obs_list, return_state=True, Sent_args=Sent_args)

    psi_t3 = ED_state_vs_time(rho0, E, V, t, iterate=False)
    psi_t33 = np.asarray(
        [psi for psi in ED_state_vs_time(rho0, E, V, t, iterate=True)]
    ).transpose((1, 2, 0))
    ...
    np.testing.assert_allclose(
        ...
        atol=atol,
        rtol=rtol,
        err_msg="mixed: Failed ED_state_vs_time test!",
    )
    np.testing.assert_allclose(
        psi_t3,
        psi_t33,
    ...
    np.testing.assert_allclose(
        psi_t2, psi_t4, atol=atol, rtol=rtol, err_msg="mixed: Failed exp_op test!"
    )
