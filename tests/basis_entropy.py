...
for DM in [DM1,DM2,DM3]:
	...
	sent=ent_entropy(DM.squeeze(),basis,sub_sys_A,densities=False)
	...
	sent=ent_entropy(DM.squeeze(),basis,chain_subsys=sub_sys_A,DM='both',densities=False)
	...
	sent=ent_entropy(DM.squeeze(),basis,chain_subsys=sub_sys_A,DM='chain_subsys',densities=False)
	...
	sent=ent_entropy(DM.squeeze(),basis,chain_subsys=sub_sys_A,DM='other_subsys',densities=False)
