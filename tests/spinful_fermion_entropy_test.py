...
psi = np.random.uniform(-1,1,size=(spinful_basis.Ns,)) + 1j*np.random.uniform(-1,1,size=(spinful_basis.Ns,))
psi /= np.linalg.norm(psi)

sp_psi = sp.csr_matrix(psi).T

psis = np.random.uniform(-1,1,size=(spinful_basis.Ns,spinful_basis.Ns)) + 1j*np.random.uniform(-1,1,size=(spinful_basis.Ns,spinful_basis.Ns))
...
kwargs_list = [
				(dict(sub_sys_A="left",return_rdm=None,return_rdm_EVs=False),	dict(density=False,sub_sys_A=up_spins,return_rdm=None,return_rdm_EVs=False)),
				...
				(dict(sub_sys_A="right",return_rdm=None,return_rdm_EVs=False),	dict(density=False,sub_sys_A=down_spins,return_rdm=None,return_rdm_EVs=False)),
