:math:`\mathrm{\color{orange} {QuSpin\ 0.3.4}}` here (updated on 2020.??.??)
============================================================================

:math:`\mathrm{\color{red} {Highlights}}`: OpenMP support here; Constrained Hilbert spaces support here; Lanczos module now here!
===================================================================
