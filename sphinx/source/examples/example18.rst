...
where :math:`i` runs over the lattice sites, :math:`j_i` over all nearest neighbours of :math:`i`, and :math:`\sigma` labels the fermion spin index. The tunneling matrix element is :math:`t`, and the interaction strength is denoted :math:`U`.
