...
We compare the entanglement entropy density value to the Page value, cf. `PRL 71, 1291 (1993) <https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.71.1291>`_, which takes into account finite-size corrections. As expected, the system heats up quickly to an infinite-temperature state.  
