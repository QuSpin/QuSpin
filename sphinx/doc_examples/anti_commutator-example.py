...
#
from quspin.operators import hamiltonian,commutator, anti_commutator # Hamiltonians and operators
...
###### calculate anti-commutator
anti_comm=anti_commutator(H1,H2)